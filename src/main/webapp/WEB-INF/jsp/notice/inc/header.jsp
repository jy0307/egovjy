...
<body>
  <!-- s:header -->
        <header class="header">
            ...
            <div class="inner">
                <a href="#LINK" class="logo"><img src="../../assets/images/logo.png" alt="구미전자정보기술원 구미형 소재·부품 융합얼라이언스 로고"></a>
                <div class="gnb_area">
                    <ul class="submenu">
                    ...
                    <div class="gnb_box">
                        ...
                        <button type="button" class="ham_sitemap"><img src="../../assets/images/btn_ham.png" alt="사이트맵버튼"></button>
                    </div>
                </div>
                
                <!----------------------------------------------- 모바일 메뉴 -->
                <div class="m_gnb_area">
                    <button type="button" class="ham_menu"><img src="../../assets/images/btn_ham.png" alt="메뉴버튼"></button>
                </div>
            </div>
            <div class="m_menu_wrap">
                ...
                <div class="m_menu_area">
                    <div class="m_submenu">
                        ...
                        <button type="button" class="m_menuclose"><img src="../../assets/images/m_menuclose.png" alt="메뉴닫기버튼"></button>
                    </div>
